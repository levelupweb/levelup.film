...
const emailBody = data => `
  <html><body> 
    <h1>Новое сообщение с сайта Film.levelupworlds.com</h1>
    <p>С сайта Film.levelupworlds.com пришло новое сообщение от потенциального клиента</p>
    <ul>
...
module.exports.emailContactHandler = (req, res) => {
  ...
  const message	= {
    text: 'Новое сообщение с сайта Film.Levelupworlds.com',
    from: config.mail.sender,
    to: `<${config.mail.receiever}>`,
    subject: 'Новое сообщение с сайта Film.Levelupworlds.com',
    attachment: [{
